...
Successfully created a routing system using Tanstack Router that covers all existing features while maintaining clean FSD architecture.
...
- 6 routes covering all features
