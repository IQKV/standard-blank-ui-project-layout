...
export const runtimeEnv = {
  VITE_API_SERVER_URL: import.meta.env.VITE_API_SERVER_URL as string | undefined,
...
export const getRuntimeConfig = (key: AppRuntimeEnvKey, fallback?: string): string | undefined =>
