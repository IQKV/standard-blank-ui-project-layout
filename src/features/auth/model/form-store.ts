...
interface FormActions {
  ...
  setFormErrors: (formId: string, errors: { [fieldName: string]: string[] }) => void;
  ...
  setFormTouched: (formId: string, touched: { [fieldName: string]: boolean }) => void;
...
export const useFormStore = createStore<FormState & FormActions>("form-store", (set) => ({
  ...initialState,
  ...
  // Form validation and error handling
  setFormErrors: (formId: string, errors: { [fieldName: string]: string[] }) =>
    set((state) => {
  ...
  setFormTouched: (formId: string, touched: { [fieldName: string]: boolean }) =>
    set((state) => {
